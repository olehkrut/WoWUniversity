...
function ($rootScope, $q, UserService, toastr) {
    ...
    var service = {
        ...
        notifyAboutNewWordSuite: notifyAboutNewWordSuite
    }
    ...
    function initialize() {
        ...
        if (!isHubConnected) {
            ...
            this.proxy.on('notifyAboutCourseChange', function (courseName) {
    ...
    function notifyAboutNewWordSuite(courseName) {
        this.proxy.invoke('NotifyAboutCourseChange',courseName);
    }
}]);